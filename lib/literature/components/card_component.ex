  ...
  def card(assigns) do
    ...
    <div class="border-2 border-gray-100 shadow-sm hover:border-primary-500 hover:-translate-y-1 hover:shadow-lg rounded-lg p-5 space-y-3 bg-white transition duration-300 ease-in-out flex flex-col">
      ...
      <div class="flex items-center justify-end">
        <%= live_patch to: @edit_path, class: "text-gray-500 bg-white focus:outline-none hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5" do %>
        ...
        <% end %>
        <%= live_redirect "Create post", to: @show_path, class: "text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center" %>
      </div>
    </div>
    """
  end
