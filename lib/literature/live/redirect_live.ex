  ...
  defp redirect_modal(assigns) do
    ...
    <.modal id="redirect-modal" on_close="close_modal">
      ...
      <:footer :let={modal}>
        ...
        <button
          type="button"
          class="w-full md:w-auto text-gray-900 bg-white border border-gray-300 focus:outline-hidden hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 md:mr-2 mb-2 text-center"
